...
let package = Package(
    ...
    products: [
        .library(name: "SkipFirebaseCore", type: .dynamic, targets: ["SkipFirebaseCore"]),
        .library(name: "SkipFirebaseFirestore", type: .dynamic, targets: ["SkipFirebaseFirestore"]),
        .library(name: "SkipFirebaseAuth", type: .dynamic, targets: ["SkipFirebaseAuth"]),
        .library(name: "SkipFirebaseAppCheck", type: .dynamic, targets: ["SkipFirebaseAppCheck"]),
        .library(name: "SkipFirebaseMessaging", type: .dynamic, targets: ["SkipFirebaseMessaging"]),
        .library(name: "SkipFirebaseCrashlytics", type: .dynamic, targets: ["SkipFirebaseCrashlytics"]),
        .library(name: "SkipFirebaseAnalytics", type: .dynamic, targets: ["SkipFirebaseAnalytics"]),
        .library(name: "SkipFirebaseRemoteConfig", type: .dynamic, targets: ["SkipFirebaseRemoteConfig"]),
        .library(name: "SkipFirebaseDatabase", type: .dynamic, targets: ["SkipFirebaseDatabase"]),
        .library(name: "SkipFirebaseFunctions", type: .dynamic, targets: ["SkipFirebaseFunctions"]),
        .library(name: "SkipFirebaseInstallations", type: .dynamic, targets: ["SkipFirebaseInstallations"]),
        .library(name: "SkipFirebaseStorage", type: .dynamic, targets: ["SkipFirebaseStorage"]),
    ],
    dependencies: [
